...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/diogo/dev/omo-profiler/.claude
                  → checks /home/diogo/dev/omo-profiler/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/diogo/dev/omo-profiler/.claude/get-shit-done
                  → writes to /home/diogo/dev/omo-profiler/.claude/get-shit-done/hooks/
...
@/home/diogo/dev/omo-profiler/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/diogo/dev/omo-profiler/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/diogo/dev/omo-profiler/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/diogo/dev/omo-profiler/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/diogo/dev/omo-profiler/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
