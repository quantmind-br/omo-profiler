...
Reference full template: `/home/diogo/dev/omo-profiler/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/diogo/dev/omo-profiler/.claude/get-shit-done/templates/state.md`.
