...
<reference>
@/home/diogo/dev/omo-profiler/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/diogo/dev/omo-profiler/.claude/get-shit-done/references/user-profiling.md` to load:
